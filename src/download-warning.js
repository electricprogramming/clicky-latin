if (!localStorage.getItem("downloadWarningAcknowledged")) {
  ...
  message.textContent = "IMPORTANT: Clicky Latin will NEVER try to download a file or app of any kind to your device. If it does, Clicky Latin has likely been hacked, and the file is likely malware, which should be deleted immediately.";
  message.style.marginBottom = "5vmin";
  message.style.fontSize = "5.25vmin"
